...
//   code add
import AllUsers from './pages/dealers/AllUsers';
import AllDealerships from './pages/dealerships/AllDealerships';
import AllGroups from './pages/dealerships/AllDealerships';
  ...
  return (
    <>
      <Routes>
        ...
        <Route path="/dealerships/all" element={<AllDealerships />} />
      </Routes>
    </>
  );
}
